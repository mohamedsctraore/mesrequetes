...
AND a.ide_gest='2023'
AND ide_jal = 'TREP'
AND a.ide_poste in (SELECT ide_poste FROM rm_poste WHERE ide_poste_centra='623C' or ide_poste='623C')
AND dat_ecr <= '30/09/2023' --BETWEEN '01/01/2023' AND '31/08/2023'
...
AND a.ide_gest='2023'
AND a.ide_poste in (SELECT ide_poste FROM rm_poste WHERE ide_poste_centra='623C' or ide_poste='623C')
--AND dat_ecr <= '05/10/2023' --BETWEEN '01/01/2023' AND '31/08/2023'
GROUP BY a.ide_poste,c.libn, a.ide_cpt, b.libn,a.cod_sens,d.ide_poste_centra
UNION
SELECT UNIQUE a.ide_poste,c.libn POSTE, d.ide_poste_centra, a.ide_cpt, b.libn,a.cod_sens, 0 DEBIT, SUM(a.mt) CREDIT
FROM fc_ligne a, fn_compte b, rm_noeud c, rm_poste d
