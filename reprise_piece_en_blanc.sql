...
select '464' ide_poste, '2025' ide_gest, 'TREP' ide_jal, 'O' flg_cptab, 148 ide_ecr, 1680 ide_lig, 'C2020' var_cpta, 'T2012' var_tiers, b.ide_tiers ide_tiers, a.ide_cpt ide_cpt, a.ide_ref_piece ide_ref_piece, a.cod_ref_piece cod_ref_piece,
...
Delete From recap_piece;

Select * From recap_piece;
...
begin
    for param_ligne in c_pgi
        loop
            select ide_ecr into v_ide_ecr from fc_ligne where ide_gest = '2025' and ide_poste = '464' and ide_jal = 'TREP' and ide_cpt = param_ligne.ide_cpt and ide_lig = param_ligne.ide_lig;
            select max(ide_lig) + 1 into v_ide_lig from fc_ligne where ide_gest = '2025' and ide_poste = '464' and ide_jal = 'TREP' and ide_ecr = param_ligne.ide_ecr;
