...
from NIABA.ETAT_CGAF_BGCT_AC a , fn_compte b, bgfg_ord_cpt c
...
select ordre ,a.ide_cpt, libl,  be_d, be_c, oa_d, oa_c, sa_d, sa_c, bs_d, bs_c,gras
from NIABA.ETAT_CGAF_BGCT_AC a
...
create table niaba.deleg_credit_tmp as

select nom_service, a.ide_cpt, libl,  sum(mt) flux_debit,0 flux_credit
from fc_ligne a , fn_compte b, bgfg_ord_cpt c, niaba.service_paierie d
...
and a.ide_cpt = c.ide_cpt
and a.ide_cpt = ide_cpt_credit
and (ide_poste, ide_jal, ide_gest, flg_cptab, ide_ecr) in (select ide_poste, ide_jal, ide_gest, flg_cptab, ide_ecr from fc_ligne a, niaba.service_paierie d where ide_poste = '401' and ide_gest = '2022'
and flg_cptab = 'O' and nom_service = 'Ambassades'
and cod_sens = 'D'
