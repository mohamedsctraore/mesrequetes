DROP TABLE piaf_adm.MOHAMED_COMPTE10;

CREATE TABLE piaf_adm.MOHAMED_COMPTE10 AS 
...
AND a.COD_SENS = 'D' 
AND (a.IDE_CPT LIKE  '47512223%')
----AND a.ide_cpt not in ('390.30','390.31','390.309.11')
AND a.ide_poste IN (SELECT ide_poste FROM rm_poste WHERE ide_poste_centra LIKE '638' OR ide_poste LIKE '638')
...
AND a.dat_ecr BETWEEN '01/01/2021' AND  '31/12/2021'
UNION 
...
SELECT * FROM piaf_adm.MOHAMED_COMPTE10 ORDER BY ide_gest,ide_cpt,(DEBIT+CREDIT),ide_tiers,ide_jal,ide_ecr,dat_ecr;
