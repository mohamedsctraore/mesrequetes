...
in (select flg_emis_recu, cod_typ_nd, ide_nd_emet, ide_mess from fm_message@asterndir where ide_gest = '2023' and cod_typ_mess = 24 and ide_nd_emet = '663'
and libl like '%CUT-PAIEMENT EFFECTIF DU 19/01/2023%')
...
select distinct 'S', rgl_num, count(*), rgl_montant_net
from cut_reglement
where pc_code = '663'
and rgl_dte_reglement like '%19/01/23%'
and rgl_mrg_code = '02'
