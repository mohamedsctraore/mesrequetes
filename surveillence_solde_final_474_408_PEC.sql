...
select ide_poste, poste, ide_poste_centra, sum(debit), sum(credit) from solde_poste_flux
having (sum(debit)- sum(credit) <> 0)
group by ide_poste, poste, ide_poste_centra
order by ide_poste;
