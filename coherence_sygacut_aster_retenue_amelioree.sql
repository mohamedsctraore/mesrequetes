...
in (select flg_emis_recu, cod_typ_nd, ide_nd_emet, ide_mess from fm_message@asterndir where ide_gest = '2024' and cod_typ_mess = 24 and ide_nd_emet = :pc_code
...
select *
from cut.cut_rejet_partiel_details
order by pc_code, ref_paiement, statut, code;
