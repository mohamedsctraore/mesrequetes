...
BEGIN
    ...
    And A.Ide_Piece In (Select Num_Liq From Fb_Piece Where Ide_Piece = '317110025100392');
    ...
    Values (v_poste, v_ide_gest, 'JPECDEPBG', 'O', v_ide_ecr_max, 1, v_var_cpta, v_var_tiers, v_ide_tiers, v_cpt_credit, v_var_bud, v_ide_lig_exec, v_ide_ordo, 'C', v_mt, 'PEC BUDGETAIRE MANDAT '|| v_ide_piece, '1', 'P', 'PEC4XX', v_dat_cpta, null, null, sysdate, 'DEV', sysdate, 'DEV', 'DEV', v_mt); 
    
    Insert Into Fc_Ligne (Ide_Poste, Ide_Gest, Ide_Jal, Flg_Cptab, Ide_Ecr, Ide_Lig, Var_Cpta, Var_tiers, Ide_tiers, ide_cpt, var_bud, ide_lig_exec, ide_ordo, cod_sens, mt, observ, ide_schema, cod_typ_schema, ide_modele_lig, dat_ecr, cod_typ_bud, cod_bud, Dat_Cre, Uti_Cre, Dat_Maj, Uti_Maj, Terminal, mt_dev)
    Values (v_poste, v_ide_gest, 'JPECDEPBG', 'O', v_ide_ecr_max, 2, v_var_cpta, null, null, v_cpt_debit, v_var_bud, null, null, 'D', v_mt, 'PEC BUDGETAIRE MANDAT '|| v_ide_piece, '1', 'P', 'PEC4XX', v_dat_cpta, null, null, sysdate, 'DEV', sysdate, 'DEV', 'DEV', v_mt); 
